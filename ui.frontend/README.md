...
### `npm run aem-component HeroBanner`

This command will create a component in ./src/components/herobanner, please follow the notes in the component generated
...
After running `npm start` **in the `ui.frontend` directory**, your app will be automatically opened in your browser (at path http://localhost:3000/content/dtnl-aem-adaptto/us/en/home.html). If you make edits, the page will reload.
